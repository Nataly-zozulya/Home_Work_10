class Hero:
    ...
    def __init__(self, name, health, rang, power, protection):
        self.name = name
        self.health = health
        self.rang = rang
        self.power = power
...
hero_1 = Hero("Ivan", 2, 3, 9, 100)
print("Захист після використання щита:", hero_1.use_sword(10))
print("Сила після використання меча:", hero_1.use_shield(300))
